...
def parse_args():
    ...
    parser.add_argument('--src', type=str, help="source of detection")
    parser.add_argument('--des', type=str, help="saving path of result")
...
if __name__ == "__main__":
    ...
    if args.op == 'al': # label tool
        ...
        detector = detect.Detector(args = args, seg_model = resunet)
        detector.create_system()
